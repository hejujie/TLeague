...
class ModelPoolAPIs(object):
    ...
    def pull_model(self, key):
        ...
        while True:
            try:
                ...
                print(
                    "ModelPoolAPIs crushed on pull_model {},"
                    " the exception:\n{}".format(key, e)
                )
    ...
    def pull_keys(self):
        ...
        while True:
            try:
                ...
                print(
                    "ModelPoolAPIs crushed on pull_keys,"
                    " the exception:\n{}".format(e)
                )
        self._req_lock.release()
        return keys
    ...
    def pull_attr(self, attr, key):
        ...
        while True:
            try:
                ...
                print(
                    "ModelPoolAPIs crushed on pull_attr {} of model {},"
                    " the exception:\n{}".format(attr, key, e)
                )
        self._req_lock.release()
        return ret_attr
    ...
    def pull_all_attr(self, attr):
        ...
        while True:
            try:
                ...
                print(
                    "ModelPoolAPIs crushed on pull_all_attr,"
                    " the exception:\n{}".format(e)
                )
        self._req_lock.release()
        return attrs
    ...
    def pull_learner_meta(self, key):
        ...
        while True:
            try:
                ...
                print(
                    "ModelPoolAPIs crushed on pull_learner_meta {},"
                    " the exception:\n{}".format(key, e)
                )
        self._req_lock.release()
        return learner_meta
    ...
    def push_model(
        ...
        self._pub_socket.send_pyobj(
            Model(model, hyperparam, key, createtime, freezetime, updatetime)
        )
