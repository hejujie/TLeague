...
from tleague.league_mgrs.league_mgr import PARLeagueMgr
...
flags.DEFINE_string(
    "game_mgr_type",
    "tleague.game_mgr.game_mgrs.RandomGameMgr",
...
flags.DEFINE_string(
    "restore_checkpoint_dir", "", "checkpoint dir from which the tleague restores. "
)
flags.DEFINE_string(
...
flags.DEFINE_integer(
    "save_interval_secs", 4800, "checkpoint saving frequency in seconds."
)
flags.DEFINE_boolean("mute_actor_msg", False, "Whether print req/rep of actors")
flags.DEFINE_boolean(
    "save_learner_meta", False, "Whether save learner's optimizer's params"
)
# printing/logging
flags.DEFINE_integer(
    "verbose",
