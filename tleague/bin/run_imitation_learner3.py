...
flags.DEFINE_multi_string(
    "learner_spec",
    ["0:10001:10002,1:10003:10004", "0:10001:10002,2:10003:10004,3:10005:10006",],
...
flags.DEFINE_string("model_pool_addrs", "localhost:10003:10004", "Model Pool address.")
flags.DEFINE_string(
    "replay_filelist", None, "Replay filelist for training and validation, csv format."
)
flags.DEFINE_string("checkpoints_dir", "./checkpoints", "Checkpoints directory.")
flags.DEFINE_string("restore_checkpoint_path", None, "Checkpoint path to restore.")
...
flags.DEFINE_integer(
    "min_train_sample_num", 10000, "Minimal number of samples to start training."
)
flags.DEFINE_integer(
    "min_val_sample_num", 4000, "Minimal number of samples to start validation."
)
...
flags.DEFINE_integer("checkpoint_interval", 50000, "Interval to save checkpoint.")
...
flags.DEFINE_integer("train_generator_worker_num", 8, "train generator worker num.")
flags.DEFINE_integer("val_generator_worker_num", 2, "validation generator worker num.")
flags.DEFINE_boolean("enable_validation", True, "Should enable validation.")
flags.DEFINE_boolean(
    "repeat_training_task", False, "Whether repeatedly sending training task."
)
flags.DEFINE_string(
    "replay_converter",
...
flags.DEFINE_string("policy", "tpolicies.convnet.pure_conv.PureConv", "policy used")
...
flags.DEFINE_integer(
    "pub_interval", 500, "freq of pub model to actors, in num of batch"
)
flags.DEFINE_boolean("use_mixed_precision", False, "Whether to use mixed precision.")
flags.DEFINE_boolean(
    "use_sparse_as_dense", True, "Whether to use sparse_as_dense in hvd optimizer."
)
