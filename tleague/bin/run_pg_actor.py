...
flags.DEFINE_string("learner_addr", "localhost:10001:10002", "Learner address")
# RL related
...
flags.DEFINE_integer("log_interval_steps", 51, "frequency of printing log in steps")
...
def main(_):
    ...
    env = create_env(FLAGS.env, env_config=env_config, inter_config=interface_config)
