...
flags.DEFINE_float(
    "data_augment_rate", -1.0, "Process data augmentation according to a ratio"
)
...
def main(_):
    ...
    replay_converter_type = getattr(
        importlib.import_module(converter_module), converter_name
    )
