...
flags.DEFINE_string("learner_id", "", "Learner id")

# RL related
flags.DEFINE_integer("unroll_length", 32, "trajectory unroll length")
flags.DEFINE_integer("rollout_length", 1, "sample n frames consecutively for RNN/LSTM.")
...
flags.DEFINE_string(
    "policy", "tpolicies.ppo.policies.DeepMultiHeadMlpPolicy", "policy used"
)
...
flags.DEFINE_integer("log_infos_interval", 20, "print infos every interval games")
