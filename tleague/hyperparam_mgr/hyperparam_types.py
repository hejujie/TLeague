...
class MutableHyperparam(Hyperparam):
    def __init__(
        ...
        lam=0.9,
        gamma=0.99,
        reward_weights=[1.0] * 11,
        reward_weights_disturb=0.1,
        **kwargs
    ):
...
class MutableHyperparamRandPerturb(Hyperparam):
  ...
  """
    ...
    def __init__(
        ...
        initial_sigma=1 / 6.0,
        reward_len=11,
        weight_perturb_percentage=0.2,
        perturb_prob=0.2,
        init_weight_low=0.1,
        init_weight_high=10.0,
        lockup_weights_ind=(0,),
        reward_scale=0.05,
        **kwargs
    ):
        # for RL training
    ...
    def __init__(
        ...
        **kwargs
        ...
        for ind, scale in zip(self._perturb_ind, reward_scale):
            self.reward_weights[ind] = scale * _loguniform(
                init_weight_low, init_weight_high
            )
        super().__init__(**kwargs)
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.reward_weights = np.array(
            random.choice(initial_reward_weights), dtype=np.float32
        )
        assert len(self.reward_weights.shape) > 0
        for ind in self._perturb_ind:
  ...
  """
    ...
    def __init__(
        ...
        **kwargs
        ...
        assert (
            self.learner_id in self.lrn_id_to_distrib_type
        ...
        if dt == "uniform":
            self.distrib = (
                np.ones(shape=(self.n_distrib,), dtype=np.float32) / self.n_distrib
            )
        elif dt == "one_hot":
    ...
    def __str__(self):
        ...
        s_distrib = (
            "n_distrib: {}, learner_id: {}, distrib_type: {}, " "zeroing_prob: {}"
        ).format(
            self.n_distrib,
            self.learner_id,
  ...
  """
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.lrn_id_to_distill_model_key = (
            lrn_id_to_distill_model_key or self.lrn_id_to_init_model_key
        )
        ...
        if "cur_idx_one_hot" not in blackboard.__dict__:
            print(
                "DiscreteDistribHyperparamV2: Initialize"
        ...
        print(
            "DiscreteDistribHyperparamV2: blackboard.cur_idx_one_hot={}".format(
                blackboard.cur_idx_one_hot
            )
        )
        ...
        if dt == "uniform":
            ...
            assert (
                self.lrn_id_to_max_n_cyclic[self.learner_id] is not None
    ...
    def __str__(self):
        ...
        s_distrib = (
            "learner_id: {}, n_distrib: {}, distrib_type: {}, "
            "distrib: {}, zeroing_prob: {}"
        ).format(
            self.learner_id,
            self.n_distrib,
            self.lrn_id_to_distrib_type[self.learner_id],
        ...
        return (
            type(self).__name__
            + ": "
            + ", ".join([s_nn, s_distrib, s_weight, s_weight_orig])
        )
...
class DiscreteDistribHyperparamV3(ConstantHyperparam):
  ...
  """
    ...
    def __str__(self):
        ...
        s_distrib = ("learner_id: {}, zstat_category: {}, " "zeroing_prob: {}").format(
            self.learner_id, self.zstat_category, self.zeroing_prob
        )
        s_weight = "rwd_weights: " + _str_list(self.reward_weights)
        s_weight_orig = "rwd_weights_orig" + _str_list(self._reward_weights_orig)
        return (
        ...
        s_nn = _str_dict(
            {
                ...
                "need_burn_in": self.need_burn_in,
...
class LpLenMutableHyperparamRandPredefSC2V1(LpLen, MutableHyperparamRandPredefSC2V1):
    def __str__(self):
        return (
            MutableHyperparamRandPredefSC2V1.__str__(self) + ", " + LpLen.__str__(self)
        )
...
class LpLenMutableHyperparamRandPredefSC2V2(LpLen, MutableHyperparamRandPredefSC2V2):
    def __str__(self):
        return (
            MutableHyperparamRandPredefSC2V2.__str__(self) + ", " + LpLen.__str__(self)
        )
...
class LpLenMutableHyperparamRandPredefSigma(LpLen, MutableHyperparamRandPredefSigma):
    def __str__(self):
        return (
            MutableHyperparamRandPredefSigma.__str__(self) + ", " + LpLen.__str__(self)
        )
...
class LpLenMutableHyperparamPartialPerturb(LpLen, MutableHyperparamPartialPerturb):
    def __str__(self):
        return (
            MutableHyperparamPartialPerturb.__str__(self) + ", " + LpLen.__str__(self)
        )


class LpLenMutableHyperparamPreDefPartialPerturb(
    LpLen, MutableHyperparamPreDefPartialPerturb
):
    def __str__(self):
        return (
            MutableHyperparamPreDefPartialPerturb.__str__(self)
            + ", "
            + LpLen.__str__(self)
        )
