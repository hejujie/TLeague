...
class TestLeagueManager(unittest.TestCase):
    ...
    def test_learner_task(self):
        ...
        league_client.notify_learner_task_begin(
            learner_id=learner_id, learner_task=task
        )
    ...
    def test_actor_task(self):
        ...
        league_client.notify_learner_task_begin(
            learner_id=learner_id, learner_task=learner_task
        )
        ...
        task = league_client.request_actor_task(
            actor_id=actor_id, learner_id=learner_id
        )
    ...
    def test_checkpoint(self):
        ...
        time.sleep(4)
        league_client.request_add_model(Model("model_data1", hyperparam, model_key1))
