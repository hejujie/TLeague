...
flags.DEFINE_string(
    "policy1",
    "tpolicies.ppo.policies.DeepMultiHeadMlpPolicy",
    "policy used for agent 1",
)
...
def main(_):
    ...
    agents = [
        ...
        for policy, ob_sp, ac_sp, name in zip(
            policies, env.observation_space.spaces, env.action_space.spaces, ["p1"]
        )
    ]
