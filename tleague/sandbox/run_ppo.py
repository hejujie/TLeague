...
FLAGS = flags.FLAGS
flags.DEFINE_string("league_mgr_addr", "localhost:10005", "League manager address.")
flags.DEFINE_string(
    "model_pool_addrs", "localhost:10006,localhost:10007", "Model Pool addresses"
)
flags.DEFINE_string(
    "learner_addrs", "localhost:10003,localhost:10004", "Learner addresses"
)
flags.DEFINE_string(
    "actor_addrs", "localhost:10000,localhost:10000,localhost:10000", "Actor addresses"
)
        ...
        try:
            if is_remote_ip(w.ip):
                ...
                run_cmd_remote(
                    ...
                    password=w.ssh_password,
                    info=worker_cmd,
                    pre_cmd=FLAGS.remote_worker_pre_cmd,
                )
                sleep(0.15)
            else:
                tmux_cmd = create_tmux_cmd(
                ...
                run_cmd_local(
                    cmd=tmux_cmd, info=worker_cmd, pre_cmd=FLAGS.local_worker_pre_cmd
                )
                sleep(0.3)
